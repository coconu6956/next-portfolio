...
export default function darkModeToggleButton() {
  ...
  return (
    <>
      <button
        className="
        inline-flex items-center bg-gray-100 border-0 py-1 px-3 
        rounded text-base mt-4 md:mt-0 dark:bg-slate-500
      ...
      >
        ...
        <svg
          ...
          viewBox="0 0 24 24"
          fill="currentColor"
          className="dark:visible invisible dark:w-5 dark:h-5 w-0 h-0"
        >
          <path
            fillRule="evenodd"
